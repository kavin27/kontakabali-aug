					...
					<div class="holidayContentSec">
						<table>
							...
							<td>
								...
								ng-change="listVal.current != 'Clear' ? (listVal.odd = false) : ''; listVal.current != 'Clear' ? (listVal.even = false) : ''">
						...
						<td>
							<select ng-model="listVal.odd" ng-disabled="(listVal.current != 'Clear' && listVal.current)">
						...
						<td>
							<select  ng-model="listVal.even" ng-disabled="(listVal.current != 'Clear' && listVal.current)">
								<option ng-if="(listVal.current != 'Clear' && listVal.current)" selected>---</option>
								<option value="Clear">Clear</option>
								<option value="Petitioner">Petitioner</option>
								<option value="Respondent">Respondent</option>
...
<script type="text/ng-template" id="myInfo3">
	<div class="row">
		...
		<div class="my_in_form">
			...
			<div class="my_in_frm_rt1 {{(myForm['myaddressState'].$touched) ? (myForm['myaddressState'].$valid ? 'valid' : 'error') : (conterror) ? (myForm['myaddressState'].$valid ? 'valid' : 'error') : ''}}"><div style="color: #5d5d5d">State</div>
						...
						<div class="row">
							<fieldset data-ng-repeat="kid in data.kids">
								<div class="col-lg-12 kidsDetails">
									...
									readonly 
									/> -->
									<input type="text" ng-model="kid.dob" ui-date="{dateFormat: 'mm/dd/yy'}" placeholder="DOB mm/dd/yyyy" />
								<!-- </div> -->
							</div>
								...
								<div class="person_res">
									...
									<div class="inputSec">
										...
										<div class="fromdate">
											...
											<input type="text" ng-model="paneaddress.fromDate" ui-date="{dateFormat: 'mm/dd/yy'}" placeholder="mm/dd/yyyy" />
										</div>
									</div>
									...
									<div class="todate">
										...
										<input type="text" ng-model="paneaddress.toDate" ui-date="{dateFormat: 'mm/dd/yy'}" placeholder="mm/dd/yyyy" />
									</div>
							</div>
						</span>			       
					</p>
	...
	<div class="row kidreview">
		...
		<div class="my_reivew" ng-repeat="kid in data.kids">
			...
			<div ng-if="data.kidsRelation.legalCustody == 'N'" class="my_review_info">
				...
				<div class="name_title2"><a href="" ng-click="reviewEdit('0','4')">Edit</a></div>
			</div>
			<div class="my_review_info">
				...
				<div class="name_title2"><a href="" ng-click="reviewEdit('0','5')">Edit</a></div>
			</div>	
			...
			<div ng-if="data.kidsRelation.physicalCustody == 'N'" class="my_review_info">
				...
				<div class="name_title2"><a href="" ng-click="reviewEdit('0','6')">Edit</a></div>
			</div>
			<div class="my_review_info">
				...
				<div class="name_title2"><a href="" ng-click="reviewEdit('0','7')">Edit</a></div>
			</div>
			<div class="my_review_info">
				...
				<div class="name_title2">
					<a href="" ng-click="reviewEdit('2','0')">Edit</a>
				</div>
			</div>
			...
			<div ng-if="data.kidsRelation.protective == 'Y'">
				<div ng-repeat="kidprotective in kid.kidsprotective">
					<div class="my_review_info">
						...
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
					<div class="my_review_info">
			...
			<div class="my_review_info">
				...
				<div class="name_title2"><a href="" ng-click="reviewEdit('2','6')">Edit</a></div>
			</div>
			<div ng-if="data.kidsRelation.legalClaims != 'N'">
				<div class="my_review_info">
					...
					<div class="name_title2"><a href="" ng-click="reviewEdit('2','7')">Edit</a></div>
				</div>
				<div class="my_review_info">
