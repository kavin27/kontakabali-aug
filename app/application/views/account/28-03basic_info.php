	...
	<div class="row kidreview">
		...
		<div class="my_reivew" ng-repeat="kid in data.kids">
			...
			<div class="my_review_info">
				...
				<div class="name_title1">{{kid.gender == 'M' ? 'Male' : kid.gender == 'F' ? 'Female' : ''}}</div>
				<div class="name_title2"><a href="" ng-click="reviewEdit('0','1')">Edit</a></div>
			</div>
			...
			<div ng-if="data.kidsRelation.legalCustody == 'N'" class="my_review_info">
				...
				{{(kid.legalCustody == null || kid.legalCustody == '') ? 'N/A' : (kid.legalCustody == 'Other') ? kid.legalCustody+" ("+kid.legalCustodyOther+")" : kid.legalCustody}}</div>
			...
			<div ng-if="data.kidsRelation.physicalCustody == 'N'" class="my_review_info">
				...
				<div class="name_title1">{{(kid.physicalCustody == null || kid.physicalCustody == '') ? 'N/A' : (kid.physicalCustody == 'Other') ? kid.physicalCustody+" ("+kid.physicalCustodyOther+")" : kid.physicalCustody}}</div>
			...
			<div class="my_review_info">
				...
				<div class="name_title1">{{(data.kidsRelation.custodySchedule == null || data.kidsRelation.custodySchedule == '') ? 'N/A' : data.kidsRelation.custodySchedule}}</div>
			...
			<div ng-if="data.kidsRelation.kidsLegalissue == 'Y'">
				<div ng-repeat="kidslegalissues in kid.kidslegalissue">
					<div class="my_review_info">
						...
						<div class="name_title1">{{(kidslegalissues.type == null || kidslegalissues.type == '') ? 'N/A' : kidslegalissues.type }}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','3')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Case Number</div>
						<div class="name_title1">{{(kidslegalissues.caseNumber == null || kidslegalissues.caseNumber == '') ? 'N/A' : kidslegalissues.caseNumber}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','3')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Court</div>
						<div class="name_title1">{{(kidslegalissues.court == null || kidslegalissues.court == '') ? 'N/A' : kidslegalissues.court}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','3')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Court Order or Judgment date</div>
						<div class="name_title1">{{(kidslegalissues.judgementDate == null || kidslegalissues.judgementDate == '') ? 'N/A' : kidslegalissues.judgementDate | date:'MM/dd/yyyy'}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','3')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Case status</div>
						<div class="name_title1">{{(kidslegalissues.caseStatus == null || kidslegalissues.caseStatus == '') ? 'N/A' : kidslegalissues.caseStatus}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','3')">Edit</a></div>
					</div>
				</div>
			</div>
			...
			<div ng-if="data.kidsRelation.protective == 'Y'">
				<div ng-repeat="kidprotective in kid.kidsprotective">
					<div class="my_review_info">
						<div class="name_title">Court</div>
						<div class="name_title1">{{(kidprotective.protectiveCourt == null || kidprotective.protectiveCourt == '') ? 'N/A' : kidprotective.protectiveCourt }}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">County</div>
						<div class="name_title1">{{(kidprotective.protectiveCountry == null || kidprotective.protectiveCountry == '') ? 'N/A' : kidprotective.protectiveCountry}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">State</div>
						<div class="name_title1">{{(kidprotective.protectiveState == null || kidprotective.protectiveState == '') ? 'N/A' : kidprotective.protectiveState}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Case Number</div>
						<div class="name_title1">{{(kidprotective.protectiveCaseNumber == null || kidprotective.protectiveCaseNumber == '') ? 'N/A' : kidprotective.protectiveCaseNumber}}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
					<div class="my_review_info">
						<div class="name_title">Order expires</div>
						<div class="name_title1">{{(kidprotective.protectiveExpire == null || kidprotective.protectiveExpire == '') ? 'N/A' : kidprotective.protectiveExpire | date:'MM/dd/yyyy' }}</div>
						<div class="name_title2"><a href="" ng-click="reviewEdit('2','5')">Edit</a></div>
					</div>
				</div>
			</div>
			...
			<div ng-if="data.kidsRelation.legalClaims != 'N'">
				<div class="my_review_info">
					<div class="name_title">Name</div>
					<div class="name_title1">{{(kid.legalClaimspersonName == null || kid.legalClaimspersonName == '') ? 'N/A' : kid.legalClaimspersonName}}, {{(kid.legalClaimspersonAddress == null || kid.legalClaimspersonAddress == '') ? 'N/A' : kid.legalClaimspersonAddress}}</div>
					<div class="name_title2"><a href="" ng-click="reviewEdit('2','7')">Edit</a></div>
				</div>
				<div class="my_review_info">
					<div class="name_title">Claims Physical</div>
					<div class="name_title1">{{kid.legalClaimspersonHasphysicalcustody ? 'Physical Custody' : 'N/A'}} / {{kid.legalClaimspersonCustodyRights ? 'Custody Rights' : 'N/A'}} / {{kid.legalClaimspersonVisitationRights ? 'Visitation Rights' : 'N/A'}}</div>
					<div class="name_title2"><a href="" ng-click="reviewEdit('2','7')">Edit</a></div>
				</div>
			</div>
...
<script type="text/ng-template" id="afterKidPopup">
	<div class="afterKidPopup">
		...
		<div class="BtnSec">
			...
			<div class="BtnSec">
				<button ng-click="PopUpHide2()">Skip & Generate Later</button>
			</div>
		</div>
	</script>
