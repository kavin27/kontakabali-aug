						...
						<svg x="0px" y="0px" width="112.964px" height="52.316px" viewBox="0 0 112.964 52.316" enable-background="new 0 0 112.964 52.316" xml:space="preserve">
							<g>
								...
								<g id="Button__x28_find_out_if_I_qualify_x29__1_">
									<text transform="matrix(1 0 0 1 30.1124 32.6964)" fill="#FFFFFF" font-family="'Lato', sans-serif" font-size="19">{{isloading ? 'Wait' : 'NEXT'}}</text>
								</g>
							</g>
						</svg>
					</button>
	...
	<div class="row">
		<div class="sect_pad">
			<div class="content_sec_side">
				...
				<p class="kids_p">
					<!-- <input type="Checkbox" id="notborn" class="ui-checkbox" name="notborn" ng-model="data.kidsRelation.notborn" ng-checked="{{ data.kidsRelation.notborn == '1' ? true : false }}">
		...
		<div class="my_reivew" ng-repeat="kid in data.kids">
			...
			<div ng-if="data.kidsRelation.legalClaims != 'N'">
				...
				<div class="my_review_info">
					...
					<div class="name_title1">
						<span class="{{kid.legalClaimspersonHasphysicalcustody ? '' : 'nr'}}">
							{{kid.legalClaimspersonHasphysicalcustody ? 'Physical Custody' : 'No Response'}}
						</span> / 
						<span class="{{kid.legalClaimspersonCustodyRights ? '' : 'nr'}}">
							{{kid.legalClaimspersonCustodyRights ? 'Custody Rights' : 'No Response'}}
						</span> / 
						<span class="{{kid.legalClaimspersonVisitationRights ? '' : 'nr'}}">
							{{kid.legalClaimspersonVisitationRights ? 'Visitation Rights' : 'No Response'}}		
						</span>
					</div>
					<div class="name_title2"><a href="" ng-click="reviewEdit('2','7')">Edit</a></div>
				</div>
