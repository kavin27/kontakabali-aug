...
<html lang="en" ng-app="project">
	<head>
		...
		<link rel="stylesheet" href="static/css/ng-scrollbar.min.css">
										...
										<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
											<nav>
												<ul class="nav nav-pills" id="mainNav">
													...
													<li ng-if="!authenticated" class="dropdown ble"><a href="#login">Sign In</a></li>		
...
<script src="static/js/ng-file-upload.js"></script>
	...
	<script src="static/js/ng-scrollbar.min.js"></script>
